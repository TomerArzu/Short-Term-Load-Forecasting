...
CustomOutputRegressionLayer = maeRegressionLayer('mae');
% CNN Layers:
layers = [
    imageInputLayer([32 32 3],"Name","imageinput")
    convolution2dLayer([3 3],32,"Name","conv_1","Padding",[0 0 0 0])
    reluLayer("Name","relu_1")
    maxPooling2dLayer([2 2],"Name","maxpool_2")
    convolution2dLayer([3 5],64,"Name","conv_2","Padding",[0 0 0 0])
    ...
    CustomOutputRegressionLayer];

[net,trainInfo] = trainNetwork(X_traning,Y_traning,layers,options);
